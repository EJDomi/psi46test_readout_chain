 ...
 *	rev:
 *
 *  modified by: Erich Schmitz 19.6.2014
 *  added: i2c LLD communication
 *
 *---------------------------------------------------------------------
 */
...
//	RPC_EXPORT bool tbm_GetRaw(uint8_t reg, uint32_t &value);
	...
	// --- i2c LLD Communication --------------------------------------------
	RPC_EXPORT void LLD_Write(uint8_t reg, uint8_t value);
	RPC_EXPORT uint8_t LLD_Read(uint8_t reg);
